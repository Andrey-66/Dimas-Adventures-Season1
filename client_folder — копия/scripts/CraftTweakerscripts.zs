...
<recipetype:tconstruct:casting_table>.addItemCastingRecipe("copper_valve_handle", <item:thermal:saw_blade>, <fluid:tconstruct:molten_clay> * 1000, <item:create:copper_valve_handle>, 200, true, true);
