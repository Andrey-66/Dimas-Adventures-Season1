...
package dimasicstructures.world.structure;
...
public class BotaniapurpuresanctuaryStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 10000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("dimasic_structures", "botania_purpure_sanctuary"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("botaniapurpuresanctuary"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dimasic_structures:botaniapurpuresanctuary"),
					configuredFeature);
		}
	}
	@SubscribeEvent
