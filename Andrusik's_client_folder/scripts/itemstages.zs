...
ItemStages.restrict(<item:dimasic_server:rainbow_dimka>, "blue");
ItemStages.restrict(<item:dimasic_server:podliva>, "yellow");
ItemStages.restrict(<item:dimasic_server:sabudka>, "green");
ItemStages.restrict(<item:dimasic_server:flag>, "pink");
ItemStages.restrict(<item:dimasic_server:poop>, "brown");
ItemStages.restrict(<item:dimasic_server:moon>, "purpure");
...
ItemStages.createModRestriction("create", s => {
    ...
    || <item:create:weathered_limestone>.matches(s) || <item:create:limestone>.matches(s) || <item:create:zinc_ingot>.matches(s) || <item:create:zinc_nugget>.matches(s)
