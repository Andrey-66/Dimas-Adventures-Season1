...
<recipetype:create:mechanical_crafting>.addRecipe("minecart_coupling", <item:create:minecart_coupling>, 
    [[<item:create:andesite_alloy>, <tag:items:forge:plates/iron>, <item:tconstruct:tool_handle>.withTag({Material: "tconstruct:iron" as string}), 
    <tag:items:forge:plates/iron>, <item:create:andesite_alloy>]]);
...
<recipetype:create:mixing>.addRecipe("mechanical_daisy", "none", <item:botanicalmachinery:mechanical_daisy>, [<item:botania:elementium_block> * 4, <item:botania:floating_pure_daisy>, <item:botania:mana_ring_greater>.withTag({mana: 2000000 as int}), <item:botania:ender_air_bottle> * 5], [<fluid:kubejs:mana_fluid> * 900]);
...
<recipetype:create:mixing>.addRecipe("controller", "superheated", <item:appliedenergistics2:controller>, [<item:botania:corporea_spark_master>, <item:appliedenergistics2:purified_fluix_crystal> * 4, <item:appliedenergistics2:smooth_sky_stone_block> * 4, <item:evilcraft:dark_gem_crushed> * 4, <item:tconstruct:tool_binding>.withTag({Material: "tconstruct:bloodbone" as string}) * 4, <item:createaddition:gold_spool> * 4, <item:ars_nouveau:marvelous_clay> * 4, <item:ars_nouveau:mythical_clay>, <item:appliedenergistics2:engineering_processor>], [<fluid:kubejs:elf_fluid> * 1000]);
...
<recipetype:create:sequenced_assembly>.addRecipe(<recipetype:create:sequenced_assembly>.builder("sequenced_assembly")
    .transitionTo(<item:mythicbotany:mana_ring_greatest>.withTag({display: {Name: "{\"text\":\"Заготовка\"}" as string}}))
    .require(<item:mythicbotany:mana_ring_greatest>)
    .loops(4)
    .addOutput(<item:botanicalmachinery:alfheim_market>, 1)
    .addStep(<recipetype:create:deploying>.factory(), (rb) => rb.require(<item:extrabotany:orichalcos>))
    .addStep(<recipetype:create:deploying>.factory(), (rb) => rb.require(<item:botania:alfheim_portal>))
    .addStep(<recipetype:create:deploying>.factory(), (rb) => rb.require(<item:evilcraft:biome_extract>.withTag({biomeKey: "betterendforge:foggy_mushroomland" as string})))
    .addStep(<recipetype:create:deploying>.factory(), (rb) => rb.require(<item:botania:glimmering_livingwood>))
    .addStep(<recipetype:create:deploying>.factory(), (rb) => rb.require(<item:thermal:enderium_gear>))
    .addStep(<recipetype:create:deploying>.factory(), (rb) => rb.require(<item:mythicbotany:alfheim_rune>))
    .addStep(<recipetype:create:pressing>.factory(), (rb) => rb.duration(500)));

<recipetype:create:mechanical_crafting>.addRecipe("mechanical_brewery", <item:botanicalmachinery:mechanical_brewery>, 
    [[<tag:items:forge:ingots/elementium>, <tag:items:forge:ingots/elementium>, <tag:items:forge:ingots/elementium>, <tag:items:forge:ingots/elementium>, <tag:items:forge:ingots/elementium>], 
    [<tag:items:forge:ingots/elementium>, <item:botania:ender_air_bottle>, <item:extrabotany:aerialite>, <item:botania:ender_air_bottle>, <tag:items:forge:ingots/elementium>], 
    [<tag:items:forge:ingots/elementium>, <item:extrabotany:aerialite>, <item:botania:brewery>, <item:extrabotany:aerialite>, <tag:items:forge:ingots/elementium>],
    [<tag:items:forge:ingots/elementium>, <item:botania:ender_air_bottle>, <item:extrabotany:aerialite>, <item:botania:ender_air_bottle>, <tag:items:forge:ingots/elementium>],
    [<tag:items:forge:ingots/elementium>, <tag:items:forge:ingots/elementium>, <tag:items:forge:ingots/elementium>, <tag:items:forge:ingots/elementium>, <tag:items:forge:ingots/elementium>]]);

<recipetype:create:sequenced_assembly>.addRecipe(<recipetype:create:sequenced_assembly>.builder("minecart")
    .transitionTo(<item:minecraft:iron_block>)
    .require(<item:minecraft:iron_block>)
    .loops(4)
    .addOutput(<item:minecraft:minecart>, 1)
    .addStep(<recipetype:create:cutting>.factory(), (rb) => rb.duration(50))
    .addStep(<recipetype:create:deploying>.factory(), (rb) => rb.require(<item:create:iron_sheet>))
    .addStep(<recipetype:create:pressing>.factory(), (rb) => rb.duration(500))
    .addStep(<recipetype:create:pressing>.factory(), (rb) => rb.duration(500))
    .addStep(<recipetype:create:pressing>.factory(), (rb) => rb.duration(500)));

<recipetype:create:mechanical_crafting>.addRecipe("molecular_assembler", <item:appliedenergistics2:molecular_assembler>, 
    [[<item:evilcraft:exalted_crafter_wooden_empowered>,<tag:items:forge:plates/iron>,<item:botania:bifrost_pane>,<item:appliedenergistics2:64k_cell_component>,<item:botania:bifrost_pane>,<tag:items:forge:plates/iron>,<item:evilcraft:exalted_crafter_wooden_empowered>], 
    [<item:minecraft:air>,<item:botania:gaia_ingot>,<tag:items:forge:ingots/enderium>,<item:ars_nouveau:glyph_craft>,<tag:items:forge:ingots/enderium>,<item:botania:gaia_ingot>,<item:minecraft:air>], 
    [<tag:items:botania:runes/sloth>,<item:appliedenergistics2:calculation_processor>,<item:botania:gaia_ingot>,<item:appliedenergistics2:matter_ball>,<item:botania:gaia_ingot>,<item:appliedenergistics2:calculation_processor>,<tag:items:botania:runes/envy>],
    [<item:minecraft:air>,<item:appliedenergistics2:formation_core>,<tag:items:forge:ingots/enderium>,<item:botania:corporea_spark>,<tag:items:forge:ingots/enderium>,<item:appliedenergistics2:annihilation_core>,<item:minecraft:air>],
    [<item:evilcraft:inverted_potentia_empowered>,<tag:items:forge:plates/iron>,<item:botania:bifrost_pane>,<tag:items:forge:plates/iron>,<item:botania:bifrost_pane>,<tag:items:forge:plates/iron>,<item:evilcraft:inverted_potentia_empowered>]]);
