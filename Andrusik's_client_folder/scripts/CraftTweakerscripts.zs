...
<recipetype:tconstruct:alloying>.addRecipe("portal", [<fluid:tconstruct:molten_ender> * 500, <fluid:tconstruct:molten_obsidian> * 2000,  <fluid:evilcraft:blood> * 250], <fluid:betterportals:portal_fluid_still> * 1000, 500);
...
<recipetype:tconstruct:casting_table>.addItemCastingRecipe("copper_valve_handle", <item:evilcraft:promise_acceptor_iron>, <fluid:tconstruct:molten_clay> * 1000, <item:create:copper_valve_handle>, 200, true, true);
...
craftingTable.addShaped("big_piano", <item:dimasic_server:bigopiano>, [
