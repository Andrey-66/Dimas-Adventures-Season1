...
<recipetype:ars_nouveau:enchanting_apparatus>.addRecipe("mmana_battery", <item:botanicalmachinery:mana_battery>, <item:botania:mana_ring_greater>, 
    [<item:extrabotany:aerialite>, <item:extrabotany:aerialite>, <item:extrabotany:aerialite>, <item:extrabotany:aerialite>, 
    <item:botania:gaia_ingot>, <item:botania:gaia_ingot>, <item:botania:gaia_ingot>, <item:botanicalmachinery:mana_emerald_block>]);

<recipetype:ars_nouveau:enchanting_apparatus>.addRecipe("wandering_trader_spawn_egg", <item:minecraft:wandering_trader_spawn_egg>, <item:minecraft:villager_spawn_egg>, 
    [<item:twilightforest:naga_scale>, <item:twilightforest:fiery_tears>, <item:twilightforest:meef_stroganoff>, <item:twilightforest:fiery_blood>, 
    <item:twilightforest:alpha_fur>, <tag:items:dimas:lich>, <tag:items:dimas:phantom>, <tag:items:dimas:bow>]);