...
craftingTable.addShaped("shapeed_kishel", <item:calemiutils:wallet>, [
...
<recipetype:thermal:pulverizer>.addRecipe("pulverizer_darkgem", [<item:evilcraft:dark_gem_crushed> % 80, <item:evilcraft:dark_gem_crushed> % 50, <item:evilcraft:dark_gem_crushed> % 20] , <item:evilcraft:dark_ore>, 5, 5000);
<recipetype:thermal:pulverizer>.addRecipe("pulverizer_netherdust", [<item:create:cinder_flour> % 100, <item:create:cinder_flour> % 80] , <item:minecraft:netherrack>, 5, 2500);
<recipetype:thermal:pulverizer>.addRecipe("pulverizer_odsidiandust", [<item:create:powdered_obsidian> % 100, <item:create:powdered_obsidian> % 25, <item:minecraft:obsidian> % 75] , <tag:items:forge:obsidian>, 8, 4500);
